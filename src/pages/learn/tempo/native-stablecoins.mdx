...
Use the Tempo Policy Registry (TIP-403) so multiple tokens can share a policy and inherit updates automatically, rather than updating each token contract individually.
