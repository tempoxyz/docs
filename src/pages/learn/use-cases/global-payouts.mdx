...
:::info
**Looking for payroll-specific guidance?** If you're a payroll provider, see [Stablecoins for Payroll](/learn/use-cases/payroll) for use cases including account funding, embedded wallets, and revenue model opportunities.
:::
