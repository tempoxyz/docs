...
|-------|----------|-------------|
| `chain` | Yes | Always `"tempo"` |
| `label` | No | Display label override |
| `coingeckoId` | Recommended | [CoinGecko API](https://www.coingecko.com) identifier for price mapping |
| `bridgeInfo` | For bridged tokens | Origin chain and contract info |
