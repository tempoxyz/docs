...
[Openfort](https://www.openfort.io) provides embedded and backend wallet infrastructure and key management APIs for developers building onchain experiences across stablecoin, fintech, and AI agent use cases. Teams can create non-custodial wallets, manage signing flows, and integrate secure authentication through a unified API.

Openfort uses [OpenSigner](https://github.com/openfort-xyz/opensigner), an open-source SSS-based signing infrastructure that gives developers full transparency and control over their key management stack.

Get started in the [Openfort Dashboard](https://dashboard.openfort.io) and follow the [documentation](https://www.openfort.io/docs) to integrate wallets into your Tempo app.
