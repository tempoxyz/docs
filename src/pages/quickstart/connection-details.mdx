...
cast block-number --rpc-url https://rpc.presto.tempo.xyz
```
...
| **Currency** | `USD` |
| **Chain ID** | `4217` |
| **HTTP URL** | `https://rpc.presto.tempo.xyz` |
| **WebSocket URL** | `wss://rpc.presto.tempo.xyz` |
...
| **Block Explorer** | [`https://explore.moderato.tempo.xyz`](https://explore.moderato.tempo.xyz) |
