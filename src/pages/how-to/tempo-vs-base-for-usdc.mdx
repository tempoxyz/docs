---
title: "Tempo vs Base for USDC"
description: "Compare Tempo and Base for USDC payments. Analyze L2 characteristics, native USDC, Coinbase ecosystem, fees, and use cases."
---

# Tempo vs Base for USDC

Base is Coinbase's Ethereum L2 with native USDC support. Tempo is a stablecoin-native chain with fees paid in stablecoins. Both offer low-cost USDC transfers—this guide compares them.
...
Pay fees in USDC, USDT, or stablecoins. Base requires ETH for gas—even when only using USDC, you must hold and manage ETH.
