...
The protocol provides the factory and shared Zone runtimes below. Each zone has its own portal proxy pointing to the shared implementation. Confirm the deployed runtime and configuration before integrating; these addresses alone do not establish execution-proof enforcement. See the [current settlement verification limits](/docs/protocol/zones/proving).
