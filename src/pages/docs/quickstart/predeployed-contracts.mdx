...
The protocol provides the factory and shared Zone runtimes below. Each zone has its own portal proxy pointing to the shared implementation. These protocol contracts do not imply production readiness: [Tempo Zones](/docs/protocol/zones) remains available for testing on Tempo Testnet only.
