...
description: Connect to live Tempo Mainnet or the separate Moderato testnet using browser wallets, CLI tools, or direct RPC endpoints.
mipd: true
interactive: true
---
...
Tempo Mainnet has been live since March 18, 2026. Use mainnet, chain ID `4217`, for Tempo Wallet, production assets such as pathUSD, and live payment flows. Moderato, chain ID `42431`, is the separate public testnet for development.
