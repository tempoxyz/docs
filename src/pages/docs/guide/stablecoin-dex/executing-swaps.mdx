...
:::info[T12 quote behavior]
At T12, quotes use the same per-order fill math and rounding as swaps for an identical state snapshot. Quote calls traverse individual orders, increasing their gas cost. Recheck quote gas limits and RPC timeouts. See [TIP-1088](https://github.com/tempoxyz/tempo/blob/main/tips/tip-1088.md).
:::
