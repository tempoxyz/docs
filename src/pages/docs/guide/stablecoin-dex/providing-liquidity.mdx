...
After the T7 network upgrade, active makers may pay less gas when they cancel eligible orders or have eligible orders filled, then later place new eligible orders. See [Storage Credits for Repeated Workflows](/docs/guide/t7-storage-credits) for the DEX benchmark and allocation pattern.
:::
...
<Cards>
  ...
  <Card
    ...
    to="/docs/protocol/exchange/spec"
