...
|---------|------|---------|-------------|----------|
| v1.10.0 (planned) | Planned: Jun 29, 2026 | Testnet + Mainnet | Required for T7; includes gas credits for expiring DEX and MPP work, dynamic base fee behavior, and removal of TIP-20 rewards. Pre-release rollout is planned for Jun 25, 2026, and release notes and binaries will be linked once published. | <Badge variant="red">Required</Badge> |
...
| | |
|---|---|
| **Scope** | Gas credits for expiring DEX and MPP work; lower the base fee when gas is below the target threshold; remove TIP-20 rewards |
...
| **Pre-release rollout** | Planned: June 25, 2026 |
| **Release date** | Planned: June 29, 2026 |
| **Testnet** | Planned: July 2, 2026 |
| **Mainnet** | Planned: July 9, 2026 |
| **Priority** | <Badge variant="red">Required</Badge> |

T7 is planned for v1.10.0, with pre-release rollout planned for June 25, 2026 and partner release planned for June 29, 2026. Release notes, binaries, and detailed node operator guidance will be linked when v1.10.0 is available.
