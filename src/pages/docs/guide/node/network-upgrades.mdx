...
T8 is active on testnet and scheduled for mainnet. It is supported by [v1.11.0](https://github.com/tempoxyz/tempo/releases/tag/v1.11.0), published on July 22, 2026. Testnet node operators were required to run the T8-compatible release before activation; mainnet node operators should run it before the July 30 activation timestamp to stay synced.
