...
|---------|------|---------|-------------|----------|
| v1.10.0 (planned) | Planned: Jun 29, 2026 | Testnet + Mainnet | Required for T7; includes gas credits for expiring DEX and MPP work, dynamic base fee behavior, and removal of TIP-20 rewards. Release notes and binaries will be linked once published. | <Badge variant="red">Required</Badge> |
