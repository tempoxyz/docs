...
|---------|------|---------|-------------|----------|
| [v1.14.0 (draft)](https://github.com/tempoxyz/tempo/releases/tag/untagged-1a8eb8b95cae9018c60e) | Planned: Sep 7, 2026 | Testnet + Mainnet | Required for [T11](/docs/protocol/upgrades/t11), scheduled for testnet on Sep 9 and mainnet on Sep 10, 2026, both at 14:00 UTC. Extends expiring-nonce validity to five minutes and hardens precompile pricing and input decoding. | <Badge variant="red">Required for T11</Badge> |
| [v1.13.2](https://github.com/tempoxyz/tempo/releases/tag/v1.13.2) | Aug 27, 2026 | Testnet + Mainnet | Fixes snapshot downloads and consensus startup, including consensus data retrieval, default download arguments, and minimal-node boundary header handling. Recommended for operators starting nodes from snapshots. | <Badge variant="amber">Recommended</Badge> |
| [v1.13.1](https://github.com/tempoxyz/tempo/releases/tag/v1.13.1) | Aug 20, 2026 | Testnet + Mainnet | Security release that hardens precompile input processing and improves Zone validation performance. Operators should upgrade promptly; no configuration changes or data migrations are required. | <Badge variant="red">High priority</Badge> |
