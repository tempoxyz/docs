...
| [v1.8.1](https://github.com/tempoxyz/tempo/releases/tag/v1.8.1) | Jun 1, 2026 | Required for T5; reverts builder prewarming and execution cache sharing defaults from v1.8.0 to avoid stale-state validation errors while retaining T5 compatibility. | <Badge variant="red">Required</Badge> |
...
| **Testnet** | Live: July 27, 2026 16:00 CEST (unix: 1785160800) |
| **Mainnet** | Scheduled: July 30, 2026 16:00 CEST (unix: 1785420000) |
| **Priority** | <Badge variant="red">Required</Badge> |

T8 is live on testnet and scheduled for mainnet. Testnet node operators should already be running [v1.11.0](https://github.com/tempoxyz/tempo/releases/tag/v1.11.0). Mainnet node operators should run [v1.11.0](https://github.com/tempoxyz/tempo/releases/tag/v1.11.0) before the activation timestamp to stay synced.
