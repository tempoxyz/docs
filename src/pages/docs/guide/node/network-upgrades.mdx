...
|---------|------|---------|-------------|----------|
| [v1.14.0](https://github.com/tempoxyz/tempo/releases/tag/v1.14.0) | Sep 7, 2026 | Testnet + Mainnet | Required for [T11](/docs/protocol/upgrades/t11). Extends expiring-nonce validity to five minutes and hardens precompile pricing and input decoding. T11 is active on testnet and mainnet. | <Badge variant="red">Required for T11</Badge> |
