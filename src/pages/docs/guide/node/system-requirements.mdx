...
| 8545 | TCP | HTTP RPC | Localhost management only, if enabled | Optional client access |
| 8546 | TCP | WebSocket RPC | Private follower endpoint (`eth,consensus`) | Optional client access |
