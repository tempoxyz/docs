...
For production validators, use the stricter [validator network topology](/docs/guide/node/validator-topology): isolate the validator, allow direct consensus traffic only with other validators, and route execution P2P through internal follower RPC nodes.
