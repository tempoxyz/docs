...
MCP clients can also post feedback directly to `https://tempo.xyz/developers/docs/api/feedback`:
...
| URL | Contents |
| --- | --- |
| [`/llms.txt`](https://tempo.xyz/developers/docs/llms.txt) | Concise index of all pages with titles and descriptions |
| [`/llms-full.txt`](https://tempo.xyz/developers/docs/llms-full.txt) | Complete documentation in a single file |
