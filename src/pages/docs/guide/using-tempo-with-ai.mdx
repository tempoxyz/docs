...
MCP clients can also post feedback directly to `https://tempo.xyz/docs/api/feedback`:
...
```
https://tempo.xyz/docs/quickstart/integrate-tempo.md
```
...
| URL | Contents |
| --- | --- |
| [`/llms.txt`](https://tempo.xyz/docs/llms.txt) | Concise index of all pages with titles and descriptions |
| [`/llms-full.txt`](https://tempo.xyz/docs/llms-full.txt) | Complete documentation in a single file |
