...
[Goldsky Edge RPC](https://docs.goldsky.com/edge-rpc/introduction) provides HTTPS JSON-RPC endpoints for Tempo Mainnet (`4217`) and Moderato Testnet (`42431`), with archive data and automatic failover across upstream providers.

Create an API key in the [Goldsky dashboard](https://app.goldsky.com), then follow the [Edge RPC quickstart](https://docs.goldsky.com/edge-rpc/quickstart) to connect to Tempo.
