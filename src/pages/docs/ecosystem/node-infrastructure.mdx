...
[GetBlock](https://getblock.io) is an RPC node provider and infrastructure platform for Web3 and AI with 130+ blockchain networks supported. GetBlock offers managed Tempo RPC infrastructure with JSON-RPC and WebSocket access, mainnet and testnet support, dedicated nodes, global clusters, and enterprise-grade reliability for teams building stablecoin payment applications on Tempo.

Get started by visiting the [Tempo chain page](https://getblock.io/nodes/tempo/), and and follow the [QuickStart guide](https://docs.getblock.io/api-reference/tempo) to create your Tempo RPC endpoint.
