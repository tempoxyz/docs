...
<Cards>
  ...
  />
  <Card
    description="Deprecated reward distribution behavior and claim path for already-accrued rewards."
...
### Legacy Reward Distribution

TIP-20 rewards are deprecated after T7. New opt-ins and distributions are no-ops, while already-accrued rewards remain claimable. See [Tempo Token Rewards](/docs/protocol/tip20-rewards/overview) for the legacy behavior and claim path.
