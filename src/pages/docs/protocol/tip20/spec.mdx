...
interface ITIP20Factory {
    ...
    /// @param currency The token's currency identifier (ISO 4217 code, when available). Immutable after creation. See Currency Declaration (https://tempo.xyz/docs/protocol/tip20/overview#currency-declaration).
