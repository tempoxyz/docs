...
description: Read Tempo protocol references for accounts, tokens, policies, fees, transactions, blockspace, exchange, zones, network upgrades, TIP specs, and implementation details.
---
...
<Cards>
  <Card
    ...
    description="Account model for root keys, access keys, passkeys, receive policies and fee preferences."
