...
The input charge below records the original T3 schedule. From T11, [TIP-1100](https://tips.sh/1100) raises it to 30 gas per 32-byte word, rounded up. See [T11 gas pricing](/docs/protocol/upgrades/t11#updated-gas-pricing) for integration guidance.
