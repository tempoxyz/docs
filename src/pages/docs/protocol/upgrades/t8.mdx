...
:::info[T8 status]
Release [v1.11.0](https://github.com/tempoxyz/tempo/releases/tag/v1.11.0) is published and required for T8. T8 is live on testnet and scheduled for mainnet on July 30, 2026.
:::
...
|-----------|------|-----------|
| Testnet activation | Live: July 27, 2026 16:00 CEST (14:00 UTC) | 1785160800 |
| Mainnet activation | July 30, 2026 16:00 CEST (14:00 UTC) | 1785420000 |

Testnet node operators should already be running [v1.11.0](https://github.com/tempoxyz/tempo/releases/tag/v1.11.0). Mainnet node operators should run [v1.11.0](https://github.com/tempoxyz/tempo/releases/tag/v1.11.0) before the July 30, 2026 activation timestamp. Nodes that are not updated before activation will fall out of sync.
