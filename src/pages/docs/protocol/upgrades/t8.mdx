...
|---------|------|-----------|
| Testnet | Live: July 27, 2026 16:00 CEST (14:00 UTC) | 1785160800 |
| Mainnet | Scheduled: July 30, 2026 16:00 CEST (14:00 UTC) | 1785420000 |

Testnet node operators were required to run [v1.11.0](https://github.com/tempoxyz/tempo/releases/tag/v1.11.0) before testnet activation. Mainnet node operators should run [v1.11.0](https://github.com/tempoxyz/tempo/releases/tag/v1.11.0) before the July 30, 2026 activation timestamp to stay synced.
...
- After activation on each network, wait for the first epoch-boundary committee update before relying on the new query.
