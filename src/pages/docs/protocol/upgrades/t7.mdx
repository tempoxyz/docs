...
|----------------|--------------|
| Active DEX makers can pay much less on repeat order placement | In the T7 DEX benchmark, same-maker reuse is about 1.21M gas cheaper after a cancel or full fill. |
...
Read [Storage Savings to Benefit Your Users](/docs/guide/t7-storage-credits) for the allocation pattern, interactive example, and DEX benchmark.
