...
Configure Viem's [`withRelay`](https://viem.sh/tempo/transports/withRelay) transport with a default RPC transport and the Tempo API sponsorship endpoint. Add your Tempo API key to the relay transport, then set `feePayer: true` when sending a transaction to request sponsorship.
...
const client = createClient({
  ...
  transport: withRelay( // [!code focus]
    ...
    http('https://api.tempo.xyz/rpc/sponsor', { // [!code focus]
