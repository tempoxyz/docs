...
Tempo Wallet CLI uses Tempo Mainnet for balances, funding, transfers, and MPP settlement. Agents should treat pathUSD in Tempo Wallet as the live mainnet asset, not as a testnet faucet token.
