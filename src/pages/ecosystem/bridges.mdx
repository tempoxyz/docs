...
[Symbiosis](https://symbiosis.finance) is a cross-chain AMM DEX that pools together liquidity across EVM and non-EVM networks. Symbiosis aggregates DEX and bridge liquidity across 50+ chains to deliver optimal cross-chain swap routes to and from Tempo, with developer integration via API, SDK, or widget.

Swap assets to Tempo through the [Symbiosis app](https://app.symbiosis.finance/swap) or explore the [Symbiosis docs](https://docs.symbiosis.finance/).
