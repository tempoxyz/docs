...
:::info[T3 status]
T3 is active on both Moderato (testnet) and Presto (mainnet).
:::
...
Node operators needed to upgrade to the T3-compatible release before the Moderato activation timestamp.
...
- Test key creation, key rotation, and recovery flows on Moderato
