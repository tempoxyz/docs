...
- Compound transfer policies ([TIP-1015](https://docs.tempo.xyz/protocol/tips/tip-1015))
- EIP-2612 permit support for TIP-20 tokens ([TIP-1004](https://docs.tempo.xyz/protocol/tips/tip-1004))
- a new Validator Config V2 precompile ([TIP-1017](https://docs.tempo.xyz/protocol/tips/tip-1017))
- and security improvements ([TIP-1036](https://docs.tempo.xyz/protocol/tips/tip-1036)).
...
- **Fee recipient configuration:** Validators should now configure fee recipients on the validator v2 contract to route block fees to a dedicated treasury address.
