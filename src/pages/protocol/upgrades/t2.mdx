...
:::info[T2 status]
T2 is active on both Moderato (testnet) and Presto (mainnet).
:::
...
Node operators needed to upgrade to the T2-compatible release before the Moderato activation timestamp.
