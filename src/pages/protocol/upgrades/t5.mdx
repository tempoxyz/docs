...
We recommend pointing `logoURI` at an SVG icon — non-SVG icons render poorly across wallets and explorers (see [tokenlist Icon Requirements](/quickstart/tokenlist#icon-requirements)).
