...
The [T5 network upgrade](/protocol/upgrades/t5) added three TIP-20 features:
...
Existing tokens continue to work unchanged. See the [T5 TIP-20 additions on the TIP-20 spec](/protocol/tip20/spec#t5-tip-20-additions) for the full ABI surface.
:::
