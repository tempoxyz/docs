...
TIP-20 tokens integrate with the [Tempo Policy Registry (TIP-403)](/protocol/tip403/overview) to enforce compliance policies. Each token can reference a policy that controls who can send and receive tokens:
