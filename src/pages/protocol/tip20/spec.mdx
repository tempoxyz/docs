...
This section captures TIP-20 changes introduced by the [T6 network upgrade](/protocol/upgrades/t6). These changes are live on testnet as of June 18, 2026 4pm CEST and are scheduled for mainnet activation on June 23, 2026 4pm CEST. After mainnet activation, the items below will be folded into the body and this appendix will be removed.
:::
