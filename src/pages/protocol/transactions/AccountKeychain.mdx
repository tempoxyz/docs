...
- Access-key-signed transactions can no longer create contracts in any configuration — including direct CREATE calls, factory CREATE, and internal CREATE2. Only root-key-signed transactions may perform contract creation.
