...
This section is for DEX integrators preparing for the [T5 network upgrade](/protocol/upgrades/t5). For a summary of what changes, see the [Coming with T5 callout](#flip-orders) under Flip Orders. Once T5 activates on Testnet (Moderato) and Mainnet (Presto), the body of this page will be rewritten to describe post-T5 behavior canonically and this appendix will be removed in a future docs revision.
:::
