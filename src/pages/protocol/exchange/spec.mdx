...
Until T5 activates, the behavior described below still applies. Indexers, SDKs, and contract code should see the [T4 → T5 migration appendix](/protocol/exchange/providing-liquidity#t4--t5-migration) on the Providing Liquidity page.
:::
