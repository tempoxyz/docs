...
Post-T3, `setRewardRecipient` rejects virtual addresses introduced by [TIP-1022](/protocol/tips/tip-1022). Reward recipients must be canonical accounts, not forwarding aliases.
