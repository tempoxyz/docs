...
<Cards>
  ...
  />
  <Card
    description="Give your AI agent access to Tempo docs, skills, MCP tools, and a wallet with built-in spend controls."
    to="/guide/using-tempo-with-ai"
    icon="lucide:bot"
    title="Using Tempo with AI"
  />
  <Card
    description="Connect to Tempo, explore SDKs, and start building with our guides."
