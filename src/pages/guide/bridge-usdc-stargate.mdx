...
# Step 1 — Quote the fee (returns fee in stablecoin units, not ETH)
...
# Step 3 — Send (no --value needed on Tempo)
# $LZ_FEE = nativeFee from the quote step (in stablecoin units)
# Destination EIDs: Ethereum = 30101, Arbitrum = 30110, Base = 30184, etc.
