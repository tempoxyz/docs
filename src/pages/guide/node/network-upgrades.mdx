...
|---------|------|---------|-------------|----------|
| v1.9.0 | TBD | Testnet + Mainnet | Required for T6; adds account-level receive policies for safer TIP-20 deposits and admin access keys for smoother passkey, device, and delegated-key management. Operators must upgrade before the T6 activation timestamps: testnet on June 18, 2026 at 4pm CEST (unix: 1781791200) and mainnet on June 23, 2026 at 4pm CEST (unix: 1782223200). | <Badge variant="red">Required</Badge> |
