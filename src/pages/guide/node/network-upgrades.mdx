...
|---------|------|---------|-------------|----------|
| v1.5.0 | Mar 26, 2026 | Moderato + Mainnet | Required for T2; implements compound transfer policies (TIP-1015), ValidatorConfig V2 (TIP-1017), and 14 audit-driven bug fixes (TIP-1036) | <Badge variant="red">Required</Badge> |
...
| **TIPs** | [TIP-1015: Compound Transfer Policies](https://docs.tempo.xyz/protocol/tips/tip-1015), [TIP-1017: Validator Config V2](https://docs.tempo.xyz/protocol/tips/tip-1017), [TIP-1036: T2 Hardfork Bug Fixes](https://docs.tempo.xyz/protocol/tips/tip-1036) |
| **Release** | v1.5.0 |
