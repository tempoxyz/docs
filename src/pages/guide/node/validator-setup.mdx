...
You should start by downloading the latest snapshot. If your validator has migrated to minimal snapshots, use Minimal. If it has not migrated yet, use Archive until that migration is complete.
