...
3. **[Submit registration details](#step-3-submit-registration-details)** — Provide the required values to register your validator on-chain.
...
:::info
Operators can submit their own registration transaction on-chain. Before registering, please [reach out to the Tempo team](mailto:partners@tempo.xyz) to align on timelines and ensure we have awareness of your validator joining the set.
:::
