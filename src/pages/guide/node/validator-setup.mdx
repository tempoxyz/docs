...
:::info
The active validator set is permissioned. Only the contract owner can add validators on-chain. Provide the values below to the Tempo team to complete registration.
:::
