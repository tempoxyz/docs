...
The active validator set is currently permissioned. If you are interested in becoming a validator, please [get in touch](mailto:partners@tempo.xyz) with the Tempo team. See [Deploying a validator](/guide/node/validator-config-v2#deploying-a-validator) for the full list of values to provide and how to generate the add-validator signature.
