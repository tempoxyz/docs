...
The active validator set is currently permissioned by the Tempo team. See [Deploying a validator](/guide/node/validator-config-v2#deploying-a-validator) for the full list of values to provide and how to generate the add-validator signature.
