...
Once the T2 hardfork is active and [ValidatorConfig V2](/guide/node/validator-config-v2) migration is complete, validators will be able to self-service key rotation, IP updates, and ownership transfers.
:::
