...
- **[ValidatorConfig V2](/guide/node/validator-config-v2)**  — self-service key rotation, IP updates, and ownership transfers
...
If you need to reset your validator's data, you must rotate to a new validator identity. See key rotation under [ValidatorConfig V2](/guide/node/validator-config-v2#rotate-validator-identity).
