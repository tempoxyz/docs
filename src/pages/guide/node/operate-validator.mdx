...
The management of the active validator set is currently permissioned by the Tempo team. To register a new validator, you must provide the following values:
...
| **Public key** | `0x`-prefixed 32-byte hex | Your ed25519 identity key. Generate one with `tempo consensus generate-private-key`. |
