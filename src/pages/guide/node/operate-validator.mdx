...
With [ValidatorConfig V2](/guide/node/validator-config-v2), you can rotate your validator's signing key self-service using the `rotateValidator` precompile call. See the [rotation guide](/guide/node/validator-config-v2#rotate-validator-identity) for details.

<details>
<summary>Legacy rotation (V1)</summary>
