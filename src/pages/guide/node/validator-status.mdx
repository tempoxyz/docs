...
flowchart LR
    A["Inactive<br/><small>Epoch E</small>"] -->|"epoch boundary"| B["Syncer<br/><small>Epoch E+1</small>"]
    B -->|"epoch boundary"| C["Player<br/><small>Epoch E+2</small>"]
    C -->|"receives share"| D["Dealer<br/><small>Epoch E+3</small>"]
    D -->|"fully synced"| E["Voter / Proposer"]
