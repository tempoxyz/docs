...
No — the active validator set is currently permissioned. Only the contract owner can add validators on-chain. You generate your keys and create the registration signature yourself, then provide them to the Tempo team for on-chain submission. [Contact the Tempo team](mailto:partners@tempo.xyz) to get started.
