...
| **Public key** | `0x`-prefixed 32-byte hex | Your ed25519 identity key. Generate one with `tempo consensus generate-private-key` (see [Generating a signing key](/guide/node/validator#generating-a-signing-key)). |
