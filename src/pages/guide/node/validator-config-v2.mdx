...
See [Initial registration](/guide/node/operate-validator#initial-registration) for the full list of values to provide and how to generate the add-validator signature.
