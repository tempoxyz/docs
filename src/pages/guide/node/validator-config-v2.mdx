...
See [Initial registration](/guide/node/validator#initial-registration) for the full list of values to provide and how to generate the add-validator signature.
