...
Alternatively, you can create the signature separately and pass it directly:

```bash
# Step 1: Create the rotation signature
...
# Step 2: Submit the rotation with the pre-computed signature
tempo consensus rotate-validator \
  --validator-address <YOUR_VALIDATOR_ADDRESS> \
  --public-key <NEW_PUBLIC_KEY> \
  --ingress <NEW_IP:PORT> \
