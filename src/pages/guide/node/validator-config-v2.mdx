...
See [Deploying a validator](/guide/node/validator#deploying-a-validator) for the full list of values to provide and how to generate the add-validator signature.
