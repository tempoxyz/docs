...
| Epoch | State | What happens |
|-------|-------|-------------|
| **E** (deactivation) | Active | Transaction is submitted. Your validator is still fully active for the remainder of this epoch. |
| **E+1** | Exiting | Your validator is a **dealer** (distributing shares) but **no longer a player** (not receiving new shares). It is in the process of being removed. |
| **E+2** | Exited | Your validator is fully out of the committee (assuming no DKG failures in E+1). |
