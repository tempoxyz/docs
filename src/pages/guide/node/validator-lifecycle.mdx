...
Keep your node running after deactivation. Use [validators-info](/guide/node/validator-status#querying-on-chain-state) to check when your validator is no longer listed — it is safe to shut down the node at that point.
