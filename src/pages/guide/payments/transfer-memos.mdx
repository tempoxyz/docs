...
description: Attach 32-byte references to TIP-20 transfers for payment reconciliation. Link onchain transactions to customer IDs, invoice numbers, and internal records.
---
