...
Before you can pay fees in a token of your choice, you need to fund your account. In this guide you will be sending `AlphaUSD` (`tempo1qqsv…9xgnd`) and paying fees in `BetaUSD` (`tempo1qqsv…mqzz2`).
