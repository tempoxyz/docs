    ...
    <form onSubmit={
      (event) => {
        ...
        sendPayment.mutate({ // [!code hl]
          ...
          // feePayer: false, // uncomment to opt out of sponsorship // [!code focus]
...
<Tabs stateKey="library">
  <Tab title="Viem">
    ...
    :::info
    Alternatively, use the [`withRelay`](https://viem.sh/tempo/transports/withRelay) transport to delegate signing to a remote fee payer service — sponsorship is automatic. See the [Steps section above](#configure-your-client-to-use-the-fee-payer-service) for setup.
    :::
