---
title: WebAuthn & P256 Signatures
description: Sign Tempo transactions with hardware security keys, Face ID, Touch ID, or passkeys. Supports secp256k1, P256, and WebAuthn signature types.
---
