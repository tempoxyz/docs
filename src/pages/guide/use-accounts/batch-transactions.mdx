...
description: Execute multiple operations atomically in a single Tempo transaction. Reduce gas costs, prevent partial failures, and improve UX with native batching.
---
