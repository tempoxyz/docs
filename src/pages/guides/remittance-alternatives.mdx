...
| Stablecoins | <0.1% | ~500ms | Digital-native recipients |
...
Stablecoins like USDC on Tempo offer a fundamentally different model: flat ~$0.001 fees regardless of amount, with instant global settlement.

### Pros

- **Flat ~$0.001 fee**: 99%+ cheaper than traditional remittance
- **Instant**: ~500ms settlement, 24/7/365
- **No FX markup**: Send USDC, receive USDC
