---
description: Framework-agnostic server handlers for Tempo protocol operations. Works with Node.js, Bun, Deno, Express, Hono, and Next.js.
---
...
const handler = Handler.feePayer({
  account,
  client,
  feeToken: 'tempo1qqsv…9xgnd' // AlphaUSD
  path: '/fee-payer',
})
