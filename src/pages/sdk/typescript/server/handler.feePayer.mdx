---
description: Create a server handler to subsidize gas costs for users. Sign transactions with a dedicated fee payer account on your backend.
---
...
const handler = Handler.feePayer({
  ...
  chain: tempoModerato.extend({ feeToken: 'tempo1qqsv…9xgnd' }), // AlphaUSD
  path: '/fee-payer',
  transport: http(),
})
```
...
const receipt = await client.token.transferSync({
  ...
  feePayer: true,
  to: 'tempo1qp6z6dwvvc6vq5efyk3ms39une6etu97hvwnw3n3',
