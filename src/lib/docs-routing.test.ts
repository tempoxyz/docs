...
describe('docs routing redirects', () => {
  describe.each(['docs.tempo.xyz', 'next.docs.tempo.xyz'])('canonical redirects for %s', (host) => {
    ...
    it.each([
      ...
      ['/docs/developer-tools/fee-payer', 'https://tempo.xyz/developers/docs/api/fee-payer'],
      ['/docs/developer-tools/indexer', 'https://tempo.xyz/developers/docs/api/indexer-api'],
      ['/docs/hosted-services', 'https://tempo.xyz/developers/docs/api'],
