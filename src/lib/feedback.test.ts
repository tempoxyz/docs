...
describe('normalizeFeedback', () => {
  it('normalizes docs feedback', () => {
    const feedback = normalizeFeedback({
      ...
      pageUrl: 'https://tempo.xyz/docs/guide/payments#send',
    ...
    expect(feedback).toMatchObject({
      ...
      category: 'Missing information',
      message: 'Needs more detail about token setup.',
      pageUrl: 'https://tempo.xyz/docs/guide/payments',
      path: '/guide/payments',
      timestamp: '2026-06-19T12:00:00.000Z',
    })
  })
  ...
  it('requires docs helpful value', () => {
    expect(() => normalizeFeedback({ source: 'docs', pageUrl: 'https://tempo.xyz/docs' })).toThrow(
      FeedbackError,
    )
  })
})
