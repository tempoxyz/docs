...
After T12 activates, you can choose distinct `uint64` nonce values for otherwise identical transactions. See [nonce discriminators](/docs/guide/payments/send-parallel-transactions#distinct-transactions-after-t12) for integration guidance.
