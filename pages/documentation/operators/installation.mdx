...
You can find the latest version of Tempo at [GitHub Releases](https://github.com/tempoxyz/tempo/releases).
...
docker pull tempoxyz/tempo:v0.2.0

# Run the Docker container
docker run -d --name tempo tempoxyz/tempo:v0.2.0 --version
docker logs tempo
```
