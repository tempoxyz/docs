...
:::note
See a full [TypeScript Example](/sdk/typescript/api/token.mint)
:::
...
:::note
See a full [TypeScript Example](/sdk/typescript/api/token.burn)
:::
...
:::note
See a full [TypeScript Example](/sdk/typescript/api/token.burnBlocked)
:::
...
:::note
See a full [TypeScript Example](/sdk/typescript/api/token.setSupplyCap)
:::
...
:::note
See a full [TypeScript Example](/sdk/typescript/api/token.pause)
:::
