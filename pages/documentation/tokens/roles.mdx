...
const result = await client.token.grantRolesSync({ // [!code focus]
...
const result = await client.token.revokeRolesSync({ // [!code focus]
...
:::code-group
```ts [pause.ts]
const result = await client.token.pauseSync({ // [!code focus]
  token: '0x20c0000000000000000000000000000000000004', // [!code focus]
}) // [!code focus]
```
