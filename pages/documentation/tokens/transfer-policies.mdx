...
:::note
See a full [TypeScript Example](/sdk/typescript/api/policy.create)
:::
...
:::note
See a full [TypeScript Example](/sdk/typescript/api/policy.modifyWhitelist)
:::
...
:::note
See a full [TypeScript Example](/sdk/typescript/api/policy.modifyBlacklist)
:::
...
:::note
See a full [TypeScript Example](/sdk/typescript/api/token.changeTransferPolicy)
:::
...
:::note
See a full [TypeScript Example](/sdk/typescript/api/policy.isAuthorized)
:::
