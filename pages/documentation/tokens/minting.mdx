...
const result = await client.token.mintSync({ // [!code focus]
...
const result = await client.token.burnSync({ // [!code focus]
  amount: parseUnits('100', 6), // [!code focus]
  token: '0x20c0000000000000000000000000000000000004', // [!code focus]
}) // [!code focus]
```
...
const result = await client.token.burnBlockedSync({ // [!code focus]
  amount: parseUnits('100', 6), // [!code focus]
...
const result = await client.token.setSupplyCapSync({ // [!code focus]
