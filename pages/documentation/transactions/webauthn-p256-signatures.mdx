...
<Callout type="info">
Additional signature types may be supported in the future. For complete technical specifications, see the [Account Abstraction](/protocol/transactions/aa-transaction) protocol documentation.
</Callout>
