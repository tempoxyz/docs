...
You can only place orders on pairs between a token and its designated quote token. All TIP-20 tokens specify a quote token for trading pairs. Most USD stablecoins use [linkingUSD](/documentation/exchange/linkingUSD) as their quote token.
...
For complete details on checking balances, depositing, withdrawing, and best practices for managing your exchange balance, see the [Exchange Balance](/documentation/exchange/exchange-balance) page.
