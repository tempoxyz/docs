...
You can only place orders on pairs between a token and its designated quote token. All TIP-20 tokens specify a quote token for trading pairs. Most USD stablecoins use [linkingUSD](/documentation/tokens/linkingUSD) as their quote token.
