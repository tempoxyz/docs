...
For complete details on checking balances, depositing, withdrawing, and managing your exchange balance, see the [Exchange Balance](/documentation/exchange/exchange-balance) page.