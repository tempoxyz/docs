...
- Fee AMM swaps 0.01 USDC → 0.00997 USDT (0.3% fee to liquidity providers)
- Validator receives 0.00997 USDT
...
- Validator receives 0.997 of their token
...
2. **Minting LP tokens** - Deposit both tokens to receive LP tokens representing your share
...
- [`amm.burn()`](/sdk/typescript/viem/amm.burn) - Remove liquidity
