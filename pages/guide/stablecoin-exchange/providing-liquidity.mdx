...
Ticks represent prices relative to the quote token (usually linkingUSD). The formula is:
...
For more details including tick precision, limits, and calculation examples, see [Understanding Ticks](/documentation/protocol/exchange/providing-liquidity#understanding-ticks).
