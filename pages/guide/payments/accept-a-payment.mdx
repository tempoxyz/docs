...
Payments are automatically credited to the recipient's address when a transfer is executed. You don't need to do anything special to "accept" a payment—it happens automatically on-chain.
...
<Demo.Container name="Receive a Payment" footerVariant="balances" tokens={[Demo.alphaUsd, Demo.betaUsd, Demo.thetaUsd]} src="tempoxyz/tempo-ts/tree/main/examples/payments">
  ...
  <Demo.AddFunds stepNumber={2} last />
</Demo.Container>
