...
import * as SponsorUserFees from '../../../components/guides/SponsorUserFees.tsx'
...
<Demo.Container name="Sponsor User Fees" footerVariant="source" src="tempoxyz/tempo-ts/tree/main/examples/payments">
  <SponsorUserFees.CreateSponsorAccount stepNumber={1} />
  <SponsorUserFees.FundSponsorAccount stepNumber={2} />
  <Demo.Connect stepNumber={3} />
  <Demo.AddFunds stepNumber={4} />
  <SponsorUserFees.SendSponsoredPayment stepNumber={5} last />
</Demo.Container>
