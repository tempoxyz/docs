...
that are decorated with [Tempo Transaction](/documentation/protocol/transactions/spec-account-abstraction) properties
...
that are decorated with [Tempo properties](/documentation/protocol/transactions/spec-account-abstraction) 
