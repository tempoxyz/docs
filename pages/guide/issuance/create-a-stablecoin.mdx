...
Create your own stablecoin on Tempo using the [TIP-20 token standard](/documentation/protocol/tip20/overview). 
...
as the [default fee token](/guide/quickstart/integrate-tempo#default-fee-token), we will need to add some `AlphaUSD` to our account.
