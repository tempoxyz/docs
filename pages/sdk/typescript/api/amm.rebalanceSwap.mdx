...
Performs a rebalance swap between user and validator tokens. [Learn more about the Fee AMM](/documentation/transactions/fee-amm)
...
Amount of output tokens desired.

### to

- **Type:** `Address`

Address to send the output tokens to.
