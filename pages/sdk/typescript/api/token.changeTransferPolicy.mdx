...
Changes the transfer policy for a TIP-20 token. Requires the default admin role. [Learn more about transfer policies](/documentation/tokens/transfer-policies)
