# Accounts [Default Account Abstraction (DAA)]

:::warning  
Deprecated  
Default Account Abstraction (DAA) is deprecated and will be removed in a future release.  
It is currently still available in the testnet, but new implementations should use [AATransaction (Type 0x76)](/protocol/transactions/aa-transaction) which provides native account abstraction support with additional features.
:::
