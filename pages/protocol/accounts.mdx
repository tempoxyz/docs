...
:::warning Deprecated
Default Account Abstraction (DAA) is deprecated. New implementations should use [AATransaction (Type 0x76)](/protocol/transactions/aa-transaction) which provides native account abstraction support with additional features.
:::
