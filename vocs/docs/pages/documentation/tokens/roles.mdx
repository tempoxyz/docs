...
const multisigAddress = '0xdeadbeefcafebabedeadbeefcafebabedeadbeef' // [!code focus]

const hash = await client.token.grantRoles({ // [!code focus]
  roles: ['defaultAdmin'], // [!code focus]
  to: multisigAddress, // [!code focus]
  token: '0x20c0000000000000000000000000000000000004', // [!code focus]
}) // [!code focus]
```
...
const hash = await client.token.revokeRoles({ // [!code focus]
  from: compromisedAddress, // [!code focus]
  roles: ['defaultAdmin', 'issuer', 'pause', 'unpause', 'burnBlocked'], // [!code focus]
  token: '0x20c0000000000000000000000000000000000004', // [!code focus]
}) // [!code focus]
```
