...
const testUSDAddress = '0x20c0000000000000000000000000000000000001' // [!code focus]
const alphaUSDAddress = '0x20c0000000000000000000000000000000000002' // [!code focus]

await client.token.approve({ // [!code focus]
  amount: parseUnits('1000', 6), // [!code focus]
  spender: ammAddress, // [!code focus]
  token: testUSDAddress, // [!code focus]
}) // [!code focus]
...
await client.amm.mint({ // [!code focus]
  ...
  userToken: { // [!code focus]
    address: testUSDAddress, // [!code focus]
    amount: parseUnits('1000', 6), // [!code focus]
  }, // [!code focus]
