...
You can override your default fee token for any individual transaction by specifying the `feeToken` parameter:
...
This allows you to:
- Use a different fee token for specific transactions
- Override your account's default fee token preference
- Pay fees in whichever stablecoin you have available
