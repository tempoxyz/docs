...
Read the [specification](https://tips.sh/1028), [learn more in the docs](/docs/protocol/upgrades/t6#account-level-receive-policies), and [try the demo](https://tempo.xyz/receive-policies).
...
Read the [specification](https://tips.sh/1049) and [learn more in the docs](/docs/protocol/upgrades/t6#admin-access-keys).
...
- [Receive policies overview](/docs/protocol/upgrades/t6#account-level-receive-policies)
- [Access keys](/docs/protocol/upgrades/t6#admin-access-keys)
