...
const svg = [
  `<svg xmlns="http://www.w3.org/2000/svg" width="840" height="570" viewBox="0 0 840 570" fill="none" font-family="Arial, Helvetica, sans-serif">
...
<rect width="840" height="570" fill="#0b0b0b"/>
<rect width="840" height="570" fill="url(#mercator-benchmark-grid)"/>
<text x="40" y="44" fill="#f2f1ec" font-size="21" font-weight="600">GPT-5.6 Luna, with Mercator</text>
<text x="40" y="70" fill="#a7a2ad" font-size="14">Mean score · WideSearch, FreshQA, GAIA, DeepSynth</text>
<path d="M 40 104 H 76" stroke="#a7a2ad" stroke-width="2" stroke-dasharray="3 5"/>
<text x="86" y="109" fill="#f2f1ec" font-size="15">Luna</text>
<path d="M 192 104 H 228" stroke="#b9a3ff" stroke-width="2.5"/>
<text x="238" y="109" fill="#f2f1ec" font-size="15">Luna + Mercator</text>
...
<text x="420" y="550" fill="#a7a2ad" font-size="12" text-anchor="middle">Four selected suites · 159 matched task pairs per setting · August 26, 2026</text>
</svg>\n`)
