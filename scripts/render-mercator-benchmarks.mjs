...
const svg = [
  `<svg xmlns="http://www.w3.org/2000/svg" width="840" height="480" viewBox="0 0 840 480" fill="none" font-family="Arial, Helvetica, sans-serif">
...
<text x="${p.x}" y="391" fill="#f2f1ec" font-size="16" text-anchor="middle">${p.effort}</text>
<text x="${p.x}" y="418" fill="#b9a3ff" font-size="14" text-anchor="middle">+${(p.mercator - p.baseline).toFixed(1)} pts</text>`)
}
svg.push(`<text x="420" y="453" fill="#a7a2ad" font-size="14" text-anchor="middle">Reasoning effort</text>
</svg>\n`)
